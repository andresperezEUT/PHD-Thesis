...
Yet, most methods for acoustic and microphone array signal processing are not specifically tailored for spherical geometries.
Therefore, there is still room for improvements in the field of automatic analysis and description of ambisonic recordings. 
...
%ADD BIBLIOGRAPHY
\bibliography{Bibliography/CoherenceEstimation, Bibliography/SELD.bib, Bibliography/Ambiscaper.bib, Bibliography/AmbisonicsDRIR.bib, Bibliography/ReverberationTimeEstimation.bib, Bibliography/Introduction.bib, Bibliography/ScientificBackground.bib}
