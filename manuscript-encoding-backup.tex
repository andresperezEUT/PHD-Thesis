...
%ADD YOUR DATA
\title{The title of the thesis:\todo{Required}}
\subtitle{The subtitle of the thesis: \todo{Required}}
\author{Author: Andrés Pérez López}
\thyear{2020}
\department{of Information and Communication Technologies}
\supervisor{}
\supervisor{Dr. Emilia Gómez Gutiérrez\\Dr. Adan Garriga Torres}
...
In order to be able to efficiently use bibliographic references, it is convenient to use the BibTeX program. To do it \cite{sartre1984ser}.
%\begin{enumerate}
